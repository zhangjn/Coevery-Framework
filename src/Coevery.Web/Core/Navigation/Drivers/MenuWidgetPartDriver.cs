    ...
    public class MenuWidgetPartDriver : ContentPartDriver<MenuWidgetPart> {
        ...
        protected override DriverResult Display(MenuWidgetPart part, string displayType, dynamic shapeHelper) {
            return ContentShape( "Parts_MenuWidget", () => {
                ...
                var menuName = menu.As<MenuPart>().Name.HtmlClassify();
        ...
        protected override DriverResult Editor(MenuWidgetPart part, string displayType, dynamic shapeHelper)
        {
        ...
        protected override DriverResult Editor(MenuWidgetPart part, IUpdateModel updater, string displayType, dynamic shapeHelper)
        {
            var model = new MenuWidgetViewModel();
