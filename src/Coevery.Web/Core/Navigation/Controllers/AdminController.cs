...
namespace Coevery.Core.Navigation.Controllers {
    [ValidateInput(false)]
    public class AdminController : Controller, IUpdateModel {
        ...
        public ActionResult Index(NavigationManagementViewModel model, int? menuId) {
            ...
            IEnumerable<MenuPart> menus = Services.ContentManager.Query<MenuPart, MenuPartRecord>().OrderBy(x => x.Name).ForType("Menu").List();
        ...
        public ActionResult IndexPOST(IList<MenuItemEntry> menuItemEntries, int? menuId) {
            ...
            // See http://coevery.codeplex.com/workitem/17116
