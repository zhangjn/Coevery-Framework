    ...
    public class CodeGenerationCommands : DefaultCoeveryCommandHandler {
        ...
        private void AddToSolution(TextWriter output, CsProjFile csProject, string solutionFolderGuid) {
            ...
            if (File.Exists(solutionPath)) {
                ...
                var modulesGuid = SolutionDirectoryModules.ToLower();
                if (solution.Projects.All(x => x.ProjectGuid.ToString() != modulesGuid)) {
                    var modulesReference = string.Format("EndProject\r\nProject(\"{{2150E333-8FDC-42A3-9474-1A3956D46DE8}}\") = \"Modules\", \"Modules\", \"{{{0}}}\"\r\n", SolutionDirectoryModules);
