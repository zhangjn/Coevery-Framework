    ...
    detour.registerController([
        ...
        ['$rootScope', '$scope', 'logger', '$state', '$q', '$resource', '$stateParams',
            function ($rootScope, $scope, logger, $state, $q, $resource, $stateParams) {
                var relationshipDataService = $resource(applicationBaseUrl + 'api/RelationshipManagement/Relationship');
                var defer = $q.defer();
                ...
                $scope.gridOptions = {
                    url: "api/RelationshipManagement/Relationship?entityName=" + $stateParams.Id,
                    rowIdName: 'ContentId',
