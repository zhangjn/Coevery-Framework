...
namespace Coevery.PropertyManagement.Handlers {
    public class ServicePartHandler : ContentHandler {
        private readonly Lazy<ISessionLocator> _sessionLocator;
        private readonly ICoeveryServices _coeveryServices;

        public ServicePartHandler(IRepository<ServicePartRecord> repository, Lazy<ISessionLocator> sessionLocator, ICoeveryServices coeveryServices) {
