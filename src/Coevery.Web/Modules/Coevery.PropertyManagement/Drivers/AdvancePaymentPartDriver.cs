...
namespace Coevery.PropertyManagement.Drivers
{
    public class PaymentPartDriver : ContentPartDriver<PaymentPart>
    {
        ...
        protected override DriverResult Editor(PaymentPart part, string displayType, dynamic shapeHelper)
        {
            return Combined(
        ...
        protected override DriverResult Editor(PaymentPart part, IUpdateModel updater, string displayType, dynamic shapeHelper)
        {
