...
namespace Nova.Select2.Controllers {
	[Themed]
    public class OpportunityController : Controller , IUpdateModel{
        private readonly ITransactionManager _transactionManager;
		private readonly IOptionSetService _optionSetService;

        public OpportunityController (ICoeveryServices services, 
		...
		public ActionResult List() {
            var contentItem = Services.ContentManager.New("Opportunity");
            contentItem.Weld(new OpportunityPart());
		...
		public ActionResult List(int page = 1, int pageSize = 10, string sortBy = null, string sortOrder = "asc") {
	        var query = Services.ContentManager.Query<OpportunityPart, OpportunityPartRecord>();
	        var totalRecords = query.Count();
	        var records = query
	            .OrderBy(sortBy, sortOrder)
	            .Slice((page - 1)*pageSize, pageSize)
	            .Select(item => new OpportunityListViewModel{
        ...
        public ActionResult CreatePost(string returnUrl) {
            ...
            Services.Notifier.Information(T("Opportunity created"));
        ...
        public ActionResult EditPost(int id, string returnUrl) {
            ...
            Services.Notifier.Information(T("Opportunity information updated"));
