...
namespace Coevery.Environment.AutofacUtil.DynamicProxy2 {
    public class DynamicProxyContext {
        const string ProxyContextKey = "Coevery.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        const string InterceptorServicesKey = "Coevery.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
