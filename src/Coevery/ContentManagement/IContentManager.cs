...
namespace Coevery.ContentManagement {
    /// <summary>
    /// Content management functionality to deal with Coevery content items and their parts
    /// </summary>
    public interface IContentManager : IDependency {
        ...
        dynamic UpdateEditor(IContent content, IUpdateModel updater, string displayType = "", string groupId = "");
    }
