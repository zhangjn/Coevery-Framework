using System;
using Coevery.Localization.Models;
...
namespace Coevery.Localization.Services {
    ...
    public interface IDateLocalizationServices : IDependency {
        ...
        /// <summary>
        /// Converts a date from UTC to the Coevery configured time zone.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from the Coevery configured time zone to UTC.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from Gregorian calendar to the Coevery configured calendar.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from the Coevery configured calendar to Gregorian calendar.
        /// </summary>
        /// <param name="parts">A <c>DateTimeParts</c> instance representing the Coevery configured calendar date to convert.</param>
