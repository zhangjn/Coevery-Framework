...
namespace Coevery.Data.Providers {
    ...
    public abstract class AbstractDataServicesProvider : IDataServicesProvider {
        ...
        public Configuration BuildConfiguration(SessionFactoryParameters parameters) {
            ...
            config = config.Database(database)
                           ...
                           .ExposeConfiguration(cfg => { 
                               ...
                               cfg.EventListeners.LoadEventListeners = new ILoadEventListener[] {new CoeveryLoadEventListener()};
        ...
        [Serializable]
        class CoeveryLoadEventListener : DefaultLoadEventListener, ILoadEventListener {
